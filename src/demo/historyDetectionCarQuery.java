...
@WebServlet("/historyDetectionCar-query")
public class historyDetectionCarQuery extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        ArrayList<DetectionResult> drList = null;
        DetectionDaoImpl ddi = new DetectionDaoImpl();
        try {
            if (id == null || id.equals("")){
                drList = ddi.historyDetectionInfo(detection_id);
            }
            else if ("testid".equals(type1)){
                drList = ddi.historyDetectionInfo(detection_id,id);
            }
            else if ("carid".equals(type1)){
                drList = ddi.historyDetectionInfoByPlate(detection_id,id);
            }
            else {
                drList = ddi.historyDetectionInfoByTime(detection_id,newtime);
            }
