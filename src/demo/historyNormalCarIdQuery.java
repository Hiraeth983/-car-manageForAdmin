...
@WebServlet("/historyNormalCarId-query")
public class historyNormalCarIdQuery extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            drList = (id == null || id.equals("")) ? ddi.historyNormalCarIdInfo(car_id) : ddi.historyNormalCarIdInfo(car_id, id);
