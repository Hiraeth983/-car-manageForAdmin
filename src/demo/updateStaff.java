...
public class updateStaff extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            boolean flag = station.updateStaff(staff);
            if (flag) {
                out.print("<script language='javascript'>alert('修改成功！');window.location.href='queryStaff?detection_id=" + detection_id + "';</script>");
            } else {
                out.print("<script language='javascript'>alert('修改失败！');window.location.href='queryStaff?detection_id=" + detection_id + "';</script>");
            }
