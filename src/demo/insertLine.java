...
@WebServlet("/insertLine")
public class insertLine extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            line.setDetection_id(request.getParameter("detection_id"));
            line.setTest_line(request.getParameter("test_line"));
            line.setLine_name(request.getParameter("line_name"));
            boolean flag = station.insertLine(line);
            if (flag) {
