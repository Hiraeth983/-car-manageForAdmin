            ...
            <div class="container-fluid">
                <div class="layui-tab layui-tab-brief" lay-filter="current">
                    <ul class="layui-tab-title">
                        <li lay-id="4" class="layui-this">历史车辆异常信息</li>
                    </ul>
                        ...
                        <div class="layui-tab-item layui-show">
                            <div class="demoTable">
                                ...
                                <div class="layui-inline">
                                    <input class="layui-input" name="id" id="demoReload4"
                                           autocomplete="off">
                            ...
                            <table class="layui-hide" id="LAY_table_user4" lay-filter="user">
                            </table>
                        </div>
                    </div>
                </div>
...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , url: 'historyExceptionCar-query?detection_id=${detection_id}' //数据接口
...
<script>
    document.getElementById("select").onchange = function () {
        var input1 = document.getElementById("demoReload4");
